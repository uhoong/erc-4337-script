...
const estimateUserOperationGas = (provider) => (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    ctx.op.preVerificationGas = est.preVerificationGas>46400?est.preVerificationGas:ethers_1.ethers.BigNumber.from("46400");
    ctx.op.verificationGasLimit = est.verificationGas;
    ctx.op.callGasLimit = est.callGasLimit;

    // ctx.op.preVerificationGas = ethers_1.ethers.BigNumber.from("85496");
    // ctx.op.verificationGasLimit = ethers_1.ethers.BigNumber.from("426240");
    // ctx.op.callGasLimit = ethers_1.ethers.BigNumber.from("63100");
});
